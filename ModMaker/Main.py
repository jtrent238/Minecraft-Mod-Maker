...
if ask_Create in ['Block', 'block', 'B', 'b']:
	...
	createMainClass.write(ask_blockName + ' = new Block(Material.rock).setBlockName("' + ask_blockName + '").setBlockTextureName("' + ask_blockName + '").setCreativeTab(''CreativeTabs.tabMisc'');' + '\n')
...
if ask_Create in ['Block', 'block', 'b']:
	createMainClass.write('GameRegistry.registerBlock(' + ask_itemName + ', "' + ask_itemName + '");' + '\n')
...
createMCForgeSrcFolder(ask_modName + '/MinecraftForge/src/main/resources/assets/minecraft/Blocks')
createMCForgeSrcFolder(ask_modName + '/MinecraftForge/src/main/resources/assets/minecraft/Items')
...
if ask_assets in ['Yes', 'yes', 'y']:
	if ask_Create in ['Block', 'block', 'b']:
		copy(ask_modName + '/assets/Blocks/' + ask_blockName + '.png', ask_modName + '/MinecraftForge/src/main/resources/assets/minecraft/Blocks')	
	if ask_Create in ['Item', 'item', 'i']:
		copy(ask_modName + '/assets/Items/' + ask_itemName + '.png', ask_modName + '/MinecraftForge/src/main/resources/assets/minecraft/Items')	
